...
with open('sentiment_result_roBERTaTEST.csv', 'r') as sentiment_file:  # input file
    reader = csv.reader(sentiment_file)
    next(reader)
    
    with open('sentiment_classification_result_roBERTaTEST.csv', 'w') as output_file:  # output file
